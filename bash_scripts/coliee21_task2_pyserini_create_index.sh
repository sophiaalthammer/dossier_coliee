#!/bin/bash
conda activate pyserini-env
create_index(){
          arg1=$1
          python -m pyserini.index -collection JsonCollection -generator DefaultLuceneDocumentGenerator  -threads 1 -input /mnt/c/Users/salthamm/Documents/phd/data/coliee2021/task2/test/$arg1/  -index /mnt/c/Users/salthamm/Documents/phd/data/coliee2021/task2/test/$arg1/index/ -storePositions -storeDocvectors -storeRaw
      }
for sub_dir in {426..525}
do
        echo $sub_dir
